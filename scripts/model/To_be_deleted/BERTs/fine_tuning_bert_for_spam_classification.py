...
dataframe = mc.getCollection("08_PreTrain", "train_data")
dataframe["onlyTextMotive"] = dataframe["onlyText"] + dataframe["identityMotive"]

df = dataframe[['country', 'onlyTextMotive']]
df = df[df["country"] != 0]
...
for epoch in range(epochs):
    ...
    #train model
    train_loss, _ = train() # PROBLEM: 'str' object has no attribute 'dim'
