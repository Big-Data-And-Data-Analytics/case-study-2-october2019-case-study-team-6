...
X = sliced_set["onlyTextMotive"]
y = sliced_set["country"]

le = LabelEncoder()
labels = le.fit_transform(y)
# split train dataset into train, validation and test sets
train_text, temp_text, train_labels, temp_labels = train_test_split(X, labels, random_state=2018, test_size=0.25) # , stratify=y
...
#for each epoch
for epoch in range(epochs): # PROBLEM: 'str' object has no attribute 'dim'
