...
collection_post = db.common_post_Combined
collection_comment = db.common_comment_Combined
collection_subcomment = db.common_subcomment_Combined
...
result_post=hastag_taglist_onlytext_function(df_post)
result_comment=hastag_taglist_onlytext_function(df_comment)
result_subcomment=hastag_taglist_onlytext_function(df_subcomment)

#result_post = result_post.to_dict(orient = "records")
#collection_post.insert_many(result_post)
